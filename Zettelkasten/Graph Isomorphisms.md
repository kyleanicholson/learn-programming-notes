...
- Yet, even if two graphs have the same number of vertices and the same number of edges, and degree sequence, they may not be isomorphic. Need to verify thru trial and error.
